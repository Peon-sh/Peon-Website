  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Export config vars, containerize (or keep using a Dockerfile if you already have one), provision Postgres on Peon or restore a dump into a Peon database, then run shadow traffic before cutting DNS. Procfile process types map cleanly to separate Peon services or Compose services — web, worker, release tasks become first-class containers instead of dyno types.',
