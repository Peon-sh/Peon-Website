...
import { SPONSOR_CHANNELS, SPONSOR_LINKS } from '@/lib/sponsors';
          ...
          <div className="mx-auto w-full max-w-3xl px-4 py-16 sm:py-20">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-md bg-primary px-8 py-3.5 text-base font-semibold text-primary-foreground hover:opacity-90"
              >
          ...
          <div className="mx-auto w-full max-w-3xl px-4 py-14">
            ...
            <div className="mt-10 space-y-6">
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  If Peon is useful to you, you can support development through GitHub Sponsors,
                  Open Collective, or a direct sponsorship. Every contribution buys more time for
                  features, docs, and support.
                </p>
              </div>
              <div>
